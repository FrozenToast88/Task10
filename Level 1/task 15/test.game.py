...
background = pygame.image.load("purpleG.JPG")
player = pygame.image.load("playerNEW.PNG")
prize = pygame.image.load("prizenew.PNG")
enemy = pygame.image.load("monsternew.PNG")
enemy2 = pygame.image.load("monsternew.PNG")
enemy3 = pygame.image.load("monsternew.PNG")
...
# Manipulated enemyXPositions so that objects do not spawn on top of each other.

enemyXPosition =  1140
enemyYPosition =  random.randint(0, screen_height - enemy_height)

enemyX2Position =  1340
enemyY2Position =  random.randint(0, screen_height - enemy_height)

enemyX3Position =  1580
enemyY3Position =  random.randint(0, screen_height - enemy_height)
...
while 1: # This is a looping structure that will loop the indented code until you tell it to stop(in the event where you exit the program by quitting). In Python the int 1 has the boolean value of 'true'. In fact numbers greater than 0 also do. 0 on the other hand has a boolean value of false. You can test this out with the bool(...) function to see what boolean value types have. You will learn more about while loop structers later. 
    ...
    screen.blit(enemy2, (enemyX2Position, enemyY2Position))
    screen.blit(enemy3, (enemyX3Position, enemyY3Position))
    ...
    if keyLeft == True:
        if playerXPosition > 1 : # This makes sure that the user does not move the player above the window.
            playerXPosition -= 5
    if keyRight == True:
    ...
    enemy2Box.top = enemyY2Position
    enemy2Box.left = enemyX2Position

    enemy3Box = pygame.Rect(enemy3.get_rect())
    enemy3Box.top = enemyY3Position
    enemy3Box.left = enemyX3Position
    ...
    if enemyXPosition < 0 - enemy_width or enemyX2Position < 0 - enemy_width or enemyX3Position < 0 - enemy_width:

        enemyX3Position -= 1.40
